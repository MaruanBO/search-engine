...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Crawler\\WebCrawlerController' => 'getWebCrawlerControllerService',
            'App\\Controller\\Document\\DocumentController' => 'getDocumentControllerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZzcgINqNjX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'app.crawler_dir' => (\dirname(__DIR__, 3).'/uploads/crawler'),
            'app.document_dir' => (\dirname(__DIR__, 3).'/uploads/document'),
            'app.index_dir' => (\dirname(__DIR__, 3).'/uploads/index'),
